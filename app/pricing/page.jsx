...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Free lab tests (up to 4 per month)",
      "Digital & downloadable prescriptions",
    ...
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
          Choose the right care plan for your health
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-600 sm:text-xl">
        Affordable healthcare packages designed to give you peace of mind—book
        appointments, get prescriptions, and lab tests in one place.
      </p>
