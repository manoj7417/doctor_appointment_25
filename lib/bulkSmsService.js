...
class BulkSmsService {
  constructor() {
    ...
    this.alternativeEndpoints = [
      'https://www.bulksmsplans.com',
      'https://api.bulksmsplans.com',
   ...
   * Most SMS APIs require international format with country code
   */
  formatPhoneNumber(phoneNumber) {
    ...
    if (cleaned.length === 10) {
      ...
      // Number too long - take last 12 digits (assuming 91 + 10 digits)
